...
<body>
  <div id="app" class="min-h-screen flex flex-col">
    ...
    @if (\Session::has('status.message'))
      <div class="mt-5 mb-3 inline-flex w-full items-center rounded-lg bg-{{\Session::get('status.type')}}-100 px-6 py-5 text-base text-{{\Session::get('status.type')}}-700" role="alert">
        <span class="mr-2">
