...
<section class="mx-auto max-w-screen-xl">
  <div class="row container mx-auto mt-4">
    <h2 class="text-principal my-4 mt-10 text-4xl font-semibold text-center">Compra fallida</h2>
    <div>
    <p class="mt-10 text-lg font-semibold text-center">El pago fue rechazado. Por favor, intentá nuevamente.</p>
    </div>
