...
<section class="mx-auto max-w-screen-xl">
  ...
  <div class="flex-1 my-4 lg:mx-6 lg:px-6">
    <form action="{{ url('/tienda/producto/nuevo') }}" method="POST" id="form-alta-prod" class="" enctype="multipart/form-data">
    @csrf
          ...
          <div class="flex justify-between">
            ...
            <div class="me-4">
              ...
              @foreach($categorias as $categoria)
                <option value="{{ $categoria->id }}"> {{ $categoria->nombre_cat }}
                </option>
              @endforeach
              </select>
            </div>
          ...
          <fieldset class="mt-4">
            ...
            @foreach($etiquetas as $etiqueta)
              <div class="form-check">
                <input class="checkboxPersonalizado" type="checkbox"
