        ...
        <div class="flex-1 my-4 lg:mx-6 lg:px-6">
            <form action="{{ url('/tienda/producto/nuevo') }}" method="POST" id="form-alt_imagen_proda-prod" class=""
                ...
                <input type="file" name="imagen_prod" id="imagen_prod"
                    class="border border-gray-500 rounded p-2 w-full @error('imagen_prod') border-red-700 @enderror"
                    @error('imagen_prod')
                    aria-invalid="true"
                ...
                <label for="alt_imagen_prod" class="block font-bold my-2"> Descripción de la imagen</label>
