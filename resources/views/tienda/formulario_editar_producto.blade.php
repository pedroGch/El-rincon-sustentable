...
<section class="mx-auto max-w-screen-xl">
      ...
      <div class="flex-1 my-4 lg:mx-6 lg:px-6">
        <form action="{{ url('/tienda/'. $producto->id .'/editar') }}" method="POST" id="form-edit-prod" enctype="multipart/form-data">
        @csrf
          <label for="nombre_prod" class="block font-bold my-2"> Nombre producto </label>
          <input type="text" name="nombre_prod" id="nombre_prod" class="border border-gray-500 rounded p-2 w-full @error('nombre_prod') border-red-700 @enderror"
          ...
          <textarea name="descripcion" id="descripcion" cols="30" rows="10"       class="border border-gray-500 rounded p-2 w-full @error('descripcion') border-red-700 @enderror"
          @error('descripcion')
          aria-invalid="true"
          ...
          <div class="flex justify-between">
            <div>
              ...
              <input type="file" name="imagen_prod" id="imagen_prod" class="border border-gray-500 rounded p-2 @error('imagen_prod') border-red-700 @enderror"
              @error('imagen_prod')
              aria-invalid="true"
            ...
            <div>
              ...
              <input type="text" name="stock" id="stock" class="border border-gray-500 rounded p-2 @error('stock') border-red-700 @enderror"
            ...
            <div class="ms-4">
              ...
              <input type="text" name="precio" id="precio" class="border border-gray-500 rounded p-2 @error('precio') border-red-700 @enderror"
          ...
          <input type="submit" class="w-6/12 botonPersonalizado" value="Enviar">
        </form>
        <a href="<?= url('/tienda/gestor_productos') ?>">
          <div class="w-6/12 botonPersonalizado">
