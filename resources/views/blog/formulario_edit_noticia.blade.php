...
@if ($errors->any())
  <div class="mt-5 mb-3 inline-flex w-full items-center rounded-lg bg-danger-100 px-6 py-5 text-base text-danger-700" role="alert">
    ...
    <div>
      <p>Hay errores en los datos ingresados. Por favor, revisalos y corregílos para poder editar correctamente la noticia.</p>
    </div>
  </div>
@endif
<section class="mx-auto max-w-screen-xl">
  ...
  <div class="flex-1 my-4 lg:mx-6 lg:px-6">
    <form action="{{ url('/blog/' . $noticia->id . '/editar') }}" method="POST" id="form-edit" enctype="multipart/form-data">
      @csrf
