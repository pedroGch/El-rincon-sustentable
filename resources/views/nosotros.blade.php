...
<section class="mx-auto max-w-screen-xl">
  ...
  <div class="flex flex-wrap">
    ...
    <div class="lg:flex-1 lg:p-10 lg:text-xl m-auto">
      ...
      <p><strong>En El Rincón Sustentable, nos enfocamos en ofrecer productos diseñados especialmente para reducir la huella de carbono y minimizar el impacto negativo en el medio ambiente.</strong>Cada uno de nuestros artículos es cuidadosamente seleccionado y evaluado para garantizar que cumpla con nuestros estándares de alta calidad, eficiencia y amigabilidad con el medio ambiente.</p>
    </div>
  </div>
  <div class="bg-principal p-8 my-8 lg:p-16 lg:my-20 lg:text-xl">
    <p class="text-white text-center"><strong>Nuestro objetivo es brindarte soluciones sostenibles para tus necesidades diarias, sin comprometer el confort ni la calidad. Creemos firmemente que cada pequeña acción cuenta y que juntos podemos marcar la diferencia en la protección de nuestro entorno.</strong></p>
  </div>
