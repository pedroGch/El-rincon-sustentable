...
@section('content')
    ...
    <section class="mb-4 mx-auto max-w-screen-xl">
      <div class="flex justify-center">
        <h2 class="text-principal my-6 mt-14 text-4xl font-semibold">Bienvenidos al <span class="font-lemonada">Rincón Sustentable</span></h2>
    </div>
    ...
    <div class="container">
      ...
      <div class="flex flex-wrap my-4 justify-between ">
        ...
        <div class="flex-1 my-4">
          <img src="../public/img/medio-ambiente.jpg" alt="manos sosteniendo un brote de una planta" class="block m-auto">
        </div>
      </div>
    </div>
    </section>
