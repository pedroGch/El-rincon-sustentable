...
<section class="mb-4 mx-auto max-w-screen-xl">
  <div class="flex justify-center">
    <h2 class="text-xl md:text-4xl text-center text-principal my-6 mt-14  font-semibold">Bienvenidos al <span class="font-lemonada">Rincón Sustentable</span></h2>
  </div>
  <div class="container">
    <div class="flex flex-wrap my-4 justify-between ">
      <div class="lg:flex-1 my-4 ms-7">
        ...
        <p class="mb-3 p-2 text-lg"> <strong>En nuestra tienda, nos enfocamos en promover prácticas responsables y sostenibles que ayuden a preservar nuestro planeta. Nuestros productos están especialmente diseñados para reducir la huella de carbono y minimizar el impacto negativo en el medio ambiente.</strong></p>
        <p class="mb-3 p-2 text-lg">Contamos con una amplia gama de productos, incluyendo paneles solares, cargadores solares, lámparas solares, compostadores y productos para el reciclaje. Todos nuestros productos son cuidadosamente seleccionados y evaluados para garantizar que sean de alta calidad, eficientes y amigables con el medio ambiente.</p>
      </div>
      <div class="lg:flex-1 my-4">
        <img src="img/medio-ambiente.jpg" alt="manos sosteniendo un brote de una planta" class="block m-auto">
      </div>
    </div>
  </div>
</section>
<section class="mb-8 mx-auto w-full bg-principal drop-shadow-xl">
  <div class="mx-auto py-5 max-w-screen-xl">
    <p class="p-3 mt-12 pb-3 lg:text-2xl text-center italic text-white">En nuestro blog, podrás encontrar información útil y consejos prácticos para ayudarte a reducir el desperdicio, ahorrar energía y crear un hogar más sostenible para disminuir tu impacto ambiental en la vida cotidiana. </p>
